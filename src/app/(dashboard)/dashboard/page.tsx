    ...
    <div className="space-y-8">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
          <div className="text-xs uppercase tracking-wide text-zinc-500">Credits</div>
          <div className="mt-1 text-2xl font-bold text-white">{balance}</div>
        </div>
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
          <div className="text-xs uppercase tracking-wide text-zinc-500">Plan</div>
          <div className="mt-1 text-2xl font-bold text-white">{plan.name}</div>
        </div>
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
          <div className="text-xs uppercase tracking-wide text-zinc-500">Requests (month)</div>
          <div className="mt-1 text-2xl font-bold text-white">{monthUsage._count}</div>
        </div>
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
          <div className="text-xs uppercase tracking-wide text-zinc-500">API keys</div>
          <div className="mt-1 text-2xl font-bold text-white">{keyCount}</div>
        </div>
      </div>
